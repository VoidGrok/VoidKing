...
function Library:CreateWindow(WindowInfo)
    ...
    do
        -- Lucide garante icone visivel; rbxassetid do Creator Store costuma ficar preto
        local FloatImage = ""
        ...
        local used = false
        if WindowInfo.Icon then
            used = applyIcon(Library:GetCustomIcon(WindowInfo.Icon))
            -- se veio rbxasset sem rect (nao e spritesheet Lucide), troca por Lucide
            if used and FloatRectSize == Vector2.zero then
