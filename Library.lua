...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        local used = false
        if WindowInfo.Icon then
            -- Aceita Lucide OU rbxassetid custom (nao forca shield)
        ...
        -- Fundo TRANSPARENTE: so a imagem aparece (sem cinza/cor atras)
        ...
        -- Imagem ocupa o botao inteiro (igual ao logo perfeito do TsuoStyle)
